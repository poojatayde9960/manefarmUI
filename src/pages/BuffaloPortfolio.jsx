...
h-12 w-52
text-xl bg-[#2D461D] text-[#A9FF67]
px-4 py-2 mr-2 rounded-full mb-6 whitespace-nowrap ">

                    <span className="w-5  h-3 mt-1 bg-[#A9FF67] ml-2 rounded-full"></span>
...
">
                ...
                <p className="text-[#000000] mt-3 text-md font-medium  font-manrope  sm:text-lg">
                    Transparent, scalable investment options with documented ownership and <br /> monthly returns.
                </p>
            </div>

            <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-4 sm:px-6">

                {/* Card 1 - 1 Buffalo */}
                <div className="w-full max-w-sm mx-auto bg-[#C9FF9F66] rounded-xl p-8 flex flex-col justify-between shadow-lg hover:shadow-xl transition-shadow">
                    <div className="-mt-4 ">
                        <h3 className="text-[#2D461D] text-2xl font-goodly">1 Buffalo</h3>
                        <p className="text-sm text-[#2D461D] mt-1 font-medium">Best For Small or growing Investors</p>
                ...
                <div className="w-full max-w-sm mx-auto bg-[#C9FF9F66] rounded-xl p-8 flex flex-col justify-between shadow-lg hover:shadow-xl transition-shadow">
                    <div className="-mt-4">
                        ...
                        <p className="text-sm text-[#2D461D] font-medium mt-1">Best For Small or growing Investors</p>
                ...
                <div className="w-full max-w-sm mx-auto bg-[#C9FF9F66] rounded-xl p-8 flex flex-col justify-between shadow-lg hover:shadow-xl transition-shadow">
                    <div className="-mt-4">
                        ...
                        <p className="text-sm text-[#2D461D] mt-1 font-medium">Perfect for serious agri-investors</p>
                    ...
                    <div className="flex items-center  mt-7">
                        <button className="flex-1 h-12 bg-[#2D461D] text-[#A9FF67] rounded-full font-medium hover:bg-[#3F6324] transition-colors flex items-center justify-center ">
                            Invest Now <ArrowRight size={18} />
                        </button>
                        <span className="w-10 h-10 flex items-center justify-center border-2 border-[#2D461D] rounded-full">
                            <Icon icon="solar:arrow-right-linear" className="text-[#2D461D] text-2xl" style={{ transform: "rotate(-30deg)" }} />
