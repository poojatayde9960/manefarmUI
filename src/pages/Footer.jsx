...
const Footer = () => {
    return (
        <div
            className="w-full text-white  font-outfit rounded-2xl mt-20 pt-10 pb-20"
            style={{
        ...
        >
            ...
            <div className="w-[95%] mx-auto bg-white rounded-3xl py-12 px-6 md:px-16 shadow-lg text-center relative">
                ...
                <div className="flex flex-col sm:flex-row md:ml-[40%] items-center justify-center sm:justify-start mt-8 gap-4 sm:gap-2 md:gap-4">
                    ...
                    <span className="w-10 h-10 sm:w-11 md:w-12 flex items-center justify-center border border-[#1E3A22] rounded-full">
                        <Icon icon="solar:arrow-right-linear" className="text-[#2D461D] text-2xl sm:text-3xl md:text-4xl" />
                    </span>
                </div>
            ...
            <div className="w-[95%] mx-auto py-16 relative">
                {/* Big Background Text */}
                <h1 className="absolute bottom-0 left-0 text-[80px] sm:text-[120px] md:text-[200px] font-bold text-white/5 select-none pointer-events-none">
                    MANET FARMS
                </h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 relative z-10">
                    {/* Left Quote */}
                    <div>
                        <p className="text-lg sm:text-xl font-light text-[#FEFAE5] leading-relaxed">
                            “Invest in nature’s strength. Grow wealth with trust, transparency, and ethical farming.”
                        </p>
                    </div>
                    ...
                    {/* Contact */}
                    <div>
                        <h3 className="font-manrope font-semibold mb-4">Contact</h3>
                        <ul className="space-y-2 text-[#A9FF67] text-sm sm:text-base">
                            <li>+91 8585 666 322</li>
                            <li>manetfarms@gmail.com</li>
                    ...
                    {/* Social Media */}
                    <div>
                        <h3 className="font-manrope font-semibold mb-4">Social Media</h3>
                        <ul className="space-y-2 text-[#A9FF67] text-sm sm:text-base">
                            <li>Whatsapp</li>
                            <li>Facebook</li>
                            <li>Instagram</li>
